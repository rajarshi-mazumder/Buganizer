...
class AppBarNav extends StatefulWidget implements PreferredSizeWidget {
  AppBarNav(
      {super.key, required this.goToHomePage, this.unreadNotificationsCount});
...
class NotificationsCount extends StatefulWidget {
  NotificationsCount({super.key, this.user, this.unreadNotificationsCount});
  User? user;
...
class _NotificationsCountState extends State<NotificationsCount> {
  getUnreadNotificationCount() async {
    await FirebaseFirestore.instance
        ...
        .then((userInfo) {
      setState(() {
        widget.unreadNotificationsCount = CurrentUserManager.notificationsCount;
      });
    });
  ...
  Widget build(BuildContext context) {
    return Positioned(
      ...
      child: Container(
        ...
        child: Text(
          widget.unreadNotificationsCount != null
