            ...
            Expanded(
              child: Container(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  items: bugStatusDefaultOpts.map((option) {
                    return DropdownMenuItem(
                      value: option['statusName'].toString(),
                      child: Text(option['statusName'].toString()),
                    );
                  }).toList(),
                  decoration: InputDecoration(
                    labelText: 'Status',
...
String getBugStatusToSet(String newStatusName) {
  String tempStatusType = 'active';
  bugStatusDefaultOpts.forEach((element) {
    if (element['statusName'] == newStatusName) {
      tempStatusType = element['statusType'];
    }
  });
